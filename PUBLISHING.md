...
The 1.3.4 release is staged directly from `v1.3.4_single_sprite_copy_gap_transparency`.

## Web / itch

Upload `Itch Uploads/yaja-2600-animator-web-v1.3.4.zip` as the HTML5 build and enable **This file will be played in the browser**. ZIP entries must use `/` separators and expose `index.html`, `index.css`, `app.bundle.js`, and `assets/` at the archive root.
...
- Run `npm ci`, `npm run check`, and `npm run build` in the v1.3.4 source folder.
